...
do
	echo $i
	# Create keystores
	"C:\Program Files\Java\jdk-14.0.2\bin\keytool.exe" -genkey -noprompt \
				 -alias $i \
	...
	"C:\Program Files\Java\jdk-14.0.2\bin\keytool.exe" -keystore kafka.$i.keystore.jks -alias $i -certreq -file $i.csr -storepass confluent -keypass confluent
	...
	"C:\Program Files\Java\jdk-14.0.2\bin\keytool.exe" -keystore kafka.$i.keystore.jks -alias CARoot -import -file snakeoil-ca-1.crt -storepass confluent -keypass confluent

	"C:\Program Files\Java\jdk-14.0.2\bin\keytool.exe" -keystore kafka.$i.keystore.jks -alias $i -import -file $i-ca1-signed.crt -storepass confluent -keypass confluent

	# Create truststore and import the CA cert.
	"C:\Program Files\Java\jdk-14.0.2\bin\keytool.exe" -keystore kafka.$i.truststore.jks -alias CARoot -import -file snakeoil-ca-1.crt -storepass confluent -keypass confluent
